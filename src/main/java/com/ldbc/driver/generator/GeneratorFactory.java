...
public class GeneratorFactory
{
    ...
    {
        Function1<Operation,Boolean,RuntimeException> isDependency = operation -> true;
    ...
    {
        return mergeSort(
                Comparator.comparingLong(Operation::scheduledStartTimeAsMilli),
                generators
        );
    }
    ...
    {
        return mergeSort(
                Comparator.comparingLong(Operation::timeStamp),
                generators
        );
    }
