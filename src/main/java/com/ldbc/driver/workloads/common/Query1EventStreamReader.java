...
import com.ldbc.driver.workloads.ontotext.ldbc.snb.interactive.LdbcQuery1;
...
public class Query1EventStreamReader implements Iterator<Operation<?>> {
	...
	public Query1EventStreamReader(Iterator<Object[]> csvRows, Workload.BENCHMARK_MODE mode) {
	...
	public Operation<?> next() {
		...
		String firstName = (String) rowAsObjects[1];
		Operation<?> operation =
				benchmarkMode == Workload.BENCHMARK_MODE.DEFAULT_BENCHMARK_MODE ?
						new com.ldbc.driver.workloads.ldbc.snb.interactive.LdbcQuery1(personId, firstName, com.ldbc.driver.workloads.ldbc.snb.interactive.LdbcQuery1.DEFAULT_LIMIT) :
						new LdbcQuery1(personId, firstName);
